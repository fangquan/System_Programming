...
cd "${TOP}"
makeDirectory ${TMPDIR}/malloc1/bin
copyFileToTmpDir "${OUTPUT_PATH}" "${TMPDIR}/${PACKAGE_TOP_DIR}bin/${OUTPUT_BASENAME}" 0755


# Generate tar file
cd "${TOP}"
rm -f dist/Default/${PLATFORM}/package/malloc1.tar
cd ${TMPDIR}
tar -vcf ../../../../dist/Default/${PLATFORM}/package/malloc1.tar *
checkReturnCode
